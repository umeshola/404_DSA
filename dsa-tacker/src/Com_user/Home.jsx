...
function Home() {
    ...
    const init = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/array/total`, {
                headers: {
    ...
    const init2 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/tree/total`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
    ...
    const init3 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/graph/total`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
    ...
    const init4 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/adv/total`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
    ...
    const init5 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/ll/total`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
    ...
    const [a, doneA] = useState(0);
    const check1 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/done/array`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
            doneA(response.data.numberOfDoneQuestions);
        } catch (error) {
            console.error('Error fetching data:', error);
        }
    };
    const [t, doneT] = useState(0);
    const check2 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/done/tree`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
            doneT(response.data.numberOfDoneQuestions);
        } catch (error) {
            console.error('Error fetching data:', error);
        }
    };
    const [g, doneG] = useState(0);
    const check3 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/done/graph`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
            doneG(response.data.numberOfDoneQuestions);
        } catch (error) {
            console.error('Error fetching data:', error);
        }
    };
    const [l, doneLL] = useState(0);
    const check4 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/done/ll`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
            doneLL(response.data.numberOfDoneQuestions);
        } catch (error) {
            console.error('Error fetching data:', error);
        }
    };
    const [ad, doneAD] = useState(0);
    const check5 = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/user/done/adv`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`
                }
            });
            doneAD(response.data.numberOfDoneQuestions);
        } catch (error) {
            console.error('Error fetching data:', error);
        }
    };
        ...
        <div style={{
            ...
            <div>
                ...
                <div style={{ paddingLeft: "200px", paddingRight: "200px", paddingTop: "50px" }}>
                    <Card style={{ display: "flex", justifyContent: "space-around", padding: "10px", borderRadius: "30px", backgroundColor: "lightblue" }}>
            ...
            <div style={{ paddingLeft: "100px", paddingRight: "100px", paddingTop: "50px", display: "flex", justifyContent: "center", flexWrap: "wrap" }}>
                <Card style={{ width: "400px", borderRadius: "25px", margin: "10px", backgroundColor: "lemonchiffon" }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div style={{ paddingLeft: "15px" }}>
                            ...
                            {a > 0 ? (
                                <>
                                    <h3 style={{fontWeight:"lighter"}}>Let's Finish {(arrayvalue-a)} remain</h3>
                                </>
                            ) : (
                                <>
                        ...
                        <div style={{ paddingTop: "50px", paddingRight: "10px" }}>
                            <Button variant="contained" style={{ borderRadius: "17px", fontWeight: "bold", fontFamily: "monospace" }} onClick={() => {
                                let type = "array"
                                navigate("/user/Data/" + type);
                            }}>Start</Button>
                        </div>
                    </div>

                </Card>
                <Card style={{ width: "400px", borderRadius: "25px", margin: "10px", backgroundColor: "lightgray" }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div style={{ paddingLeft: "15px" }}>
                            <h1>LinkList</h1>
                            ...
                            {l > 0 ? (
                                <>
                                    <h3  style={{fontWeight:"lighter"}}>Let's Finish {llvalue-l} remain </h3>
                                </>
                            ) : (
                                <>
                                    <h3>Not yet started</h3>
                ...
                <Card style={{ width: "400px", borderRadius: "25px", margin: "10px", backgroundColor: "lightgreen" }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div style={{ paddingLeft: "15px" }}>
                            <h1>Tree</h1>
                            ...
                            {t > 0 ? (
                                <>
                                    <h3  style={{fontWeight:"lighter"}}>Let's Finish {treevalue-t} remain</h3>
                                </>
                            ) : (
                                <>
                                    <h3>Not yet started</h3>
                ...
                <Card style={{ width: "400px", borderRadius: "25px", margin: "10px", backgroundColor: "lightseagreen" }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div style={{ paddingLeft: "15px" }}>
                            <h1>Graph</h1>
                            ...
                            {g > 0 ? (
                                <>
                                    <h3  style={{fontWeight:"lighter"}}>Let's Finish {graphvalue-g} remain</h3>
                                </>
                            ) : (
                                <>
                                    <h3>Not yet started</h3>
                ...
                <Card style={{ width: "400px", borderRadius: "25px", margin: "10px", backgroundColor: "lightyellow" }}>
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                        <div style={{ paddingLeft: "15px" }}>
                            <h1>Adv</h1>
                            ...
                            {ad > 0 ? (
                                <>
                                    <h3  style={{fontWeight:"lighter"}}>Let's Finish {advvalue-ad}</h3>
                                </>
                            ) : (
                                <>
                                    <h3>Not yet started</h3>
